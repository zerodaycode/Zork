...
pub enum LanguageLevel {
    #[serde(alias="98")] CPP98,
    #[serde(alias="03")] CPP03,
    #[serde(alias="11")] CPP11,
    #[serde(alias="14")] CPP14,
    #[serde(alias="17")] CPP17,
    #[serde(alias="20")] CPP20,
    #[serde(alias="23")] CPP23,
    #[serde(alias="2a")] CPP2A,
    #[serde(alias="2b")] CPP2B,
    #[serde(alias="latest")] LATEST
}
