...
/// let parser = CliArgs::parse_from(["","-n","ZeroDayCodeTemplate","-l","-g","-c","clang"]);
...
pub struct CliArgs {
    ...
    #[arg(short, long, help="To generate a C++ modules project or a classical one with headers, can you use with template project")]
    pub legacy: bool,
    #[arg(short, long, help="Initializes a new local git repo, can you use with template project")]
    pub git: bool,
    #[arg(short, long, help="Indicates what compiler wants the user to use with the autogenerated project mode, can you use with template project")]
