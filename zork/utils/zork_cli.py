...
from utils.constants import \
    ...
    MAIN_CPP, SRC_MOD_FILE, OS, WINDOWS
...
def command_line_interface():
    ...
    parser.add_argument(
        ...
        dest='tests',
        action='store_true',
        help='Builds all the test files added as sources'
    )
...
def new_project_autogenerator(
    ...
    subprocess.Popen(['mkdir', f'{project_name}/ifc']).wait()
