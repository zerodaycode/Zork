...
def test_get_project_config():
    ...
    expected_dict_after_parsing: dict = {
        ...
        'executable': ExecutableConfig('<autogenerated_executable>', '', ['*.cpp'], 'true', []),
    ...
    assert expected_dict_after_parsing['compiler'].extra_args == \
        parsed_config['compiler'].extra_args
    ...
    assert expected_dict_after_parsing['executable'].extra_args == \
        parsed_config['executable'].extra_args
    ...
    assert expected_dict_after_parsing['tests'].extra_args == \
        parsed_config['tests'].extra_args